//Wed May 07 2025 02:07:50 GMT+0000 (Coordinated Universal Time)
//Base:https://github.com/echo094/decode-js
//Modify:https://github.com/smallfawn/decode_action
const _0x59a330 = new _0xc5c85b("七猫免费小说");
let _0x3b75f9 = ["@", "\n"];
let _0x2d4e87 = "qmxsCookie";
let _0x3d031c = (_0x59a330.isNode() ? process.env[_0x2d4e87] : _0x59a330.getdata(_0x2d4e87)) || "";
let _0x5ad10f = [];
let _0x26741a = 0;
let _0x3d531e = 0;
let _0x2b94cc = new _0x2d19bf();
class _0x1419e0 {
  ...
  async taskApi(_0xa878b5 = {}, _0x406af7) {
    let _0x504a62 = {};
    try {
      let _0x58ba64 = _0xa878b5.url.replace("//", "/").split("/")[1];
      ...
      if (_0xa878b5.body) {
        _0x44a440.headers["Content-Type"] = _0xa878b5["Content-Type"] || "application/x-www-form-urlencoded";
        if (typeof _0xa878b5.body === "object") {
          if (_0x44a440.headers["Content-Type"].includes("json")) {
            _0x44a440.body = JSON.stringify(_0xa878b5.body);
          } else {
            ...
            _0x44a440.body = _0x59a330.json2str(_0xa878b5.body, "&");
          }
        } else {
          _0x44a440.body = _0xa878b5.body;
        }
      }
      if (_0xa878b5.urlObjectParam) {
        Object.assign(_0x44a440, _0xa878b5.urlObjectParam);
      }
      if (_0xa878b5.headerParam) {
        Object.assign(_0x44a440.headers, _0xa878b5.headerParam);
      }
      _0x504a62 = Object.assign({}, await _0x1dc0d6(_0xa878b5.method, _0x44a440));
      if (_0x504a62.err) {
  ...
  async userx() {
    ...
    try {
      ...
      let _0x32cbde = [_0x42bf16, _0xea1e88, _0x1face2, _0x1afba7];
      ...
      let _0x19ad45 = [_0x2983cf, _0x18e994];
  ...
  async user() {
    ...
    try {
      ...
      _0x5f29ed = Object.assign({}, await this.taskApi(_0x2415d3, _0x28a42a));
      if (200 == _0x5f29ed?.["statusCode"]) {
        let _0x22d9d2 = _0x5f29ed?.["result"];
        if (_0x22d9d2.errors) {
          console.log(this.idx + " " + _0x2415d3.fn + " " + _0x22d9d2.errors.title + "\n");
        }
        if (!_0x22d9d2.errors) {
          console.log(this.idx + " " + _0x2415d3.fn + " " + _0x22d9d2.data.reward_cash + "\n");
        }
        await this.video();
      }
    } catch (_0x243492) {
  ...
  async userw() {
    ...
    try {
      ...
      let _0x3f8436 = _0x2e6031.length;
      let _0x1fe023 = {
      ...
      _0x5357f2 = Object.assign({}, await this.taskApi(_0x3b21ed, _0x1fe023));
      if (200 == _0x5357f2?.["statusCode"]) {
        let _0x52d919 = _0x5357f2?.["result"];
        if (_0x52d919.errors) {
          console.log(this.idx + " " + _0x3b21ed.fn + " " + _0x52d919.errors.title + "\n");
          this.fx = 1;
        }
        if (!_0x52d919.errors) {
          console.log(this.idx + " " + _0x3b21ed.fn + " " + _0x52d919.data.coin + "\n");
        }
      }
    } catch (_0x102c83) {
  ...
  async readvideo() {
    ...
    try {
      ...
      _0x3c2502 = Object.assign({}, await this.taskApi(_0x28a43f, _0x243c55));
      if (200 == _0x3c2502?.["statusCode"]) {
        let _0x4f6878 = _0x3c2502?.["result"];
        if (!_0x4f6878.errors) {
          console.log(this.idx + " " + _0x28a43f.fn + " " + _0x4f6878.data.result + "\n");
        }
      }
    } catch (_0x213e9a) {
  ...
  async goldvideo() {
    ...
    try {
      ...
      _0x5651e6 = Object.assign({}, await this.taskApi(_0x12ea62, _0x4a927b));
    } catch (_0x463ba3) {
  ...
  async finish() {
    ...
    try {
      ...
      _0x141b4a = Object.assign({}, await this.taskApi(_0x109307, _0x185a8d));
      if (200 == _0x141b4a?.["statusCode"]) {
        let _0x35fafa = _0x141b4a?.["result"];
        await this.reward();
      }
    } catch (_0x5e8a6b) {
  ...
  async reward() {
    ...
    try {
      ...
      _0x32f2b2 = Object.assign({}, await this.taskApi(_0x2e881f, _0x8f16a4));
      if (200 == _0x32f2b2?.["statusCode"]) {
        let _0x1b6258 = _0x32f2b2?.["result"];
        if (_0x1b6258.errors) {
          console.log(this.idx + " " + _0x2e881f.fn + " " + _0x1b6258.errors.title + "\n");
        }
        if (!_0x1b6258.errors) {
          console.log(this.idx + " " + _0x2e881f.fn + " " + _0x1b6258.data.reward_cash + "\n");
        }
      }
    } catch (_0x559ffd) {
  ...
  async video() {
    ...
    try {
      ...
      _0x371133 = Object.assign({}, await this.taskApi(_0x20e290, _0x22287a));
      if (200 == _0x371133?.["statusCode"]) {
        let _0x1f9d5d = _0x371133?.["result"];
        if (_0x1f9d5d.errors) {
          console.log(this.idx + " " + _0x20e290.fn + " " + _0x1f9d5d.errors.title + "\n");
        }
        if (!_0x1f9d5d.errors) {
          console.log(this.idx + " " + _0x20e290.fn + " " + _0x1f9d5d.data.reward_cash + "\n");
        }
      }
    } catch (_0x1c1dc6) {
  ...
  async abc() {
    ...
    try {
      ...
      _0x30458d = Object.assign({}, await this.taskApi(_0x42a6f5, _0x39e2da));
      if (200 == _0x30458d?.["statusCode"] && _0x30458d.result) {
        let _0x28c76a = _0x30458d.result;
        let _0x406ffc = _0x28c76a.data.coin_data;
        console.log("\n\n\n" + this.idx + " " + _0x42a6f5.fn + " 当前金币 " + _0x406ffc.coin + " 约 " + _0x406ffc.coin_to_cash + " 元\n");
      }
    } catch (_0x135c6e) {
  ...
  async draw() {
    ...
    try {
      ...
      _0x30abe5 = Object.assign({}, await this.taskApi(_0x4f9eb8, _0x242676));
      if (200 == _0x30abe5?.["statusCode"] && _0x30abe5.result) {
        let _0x201aac = _0x30abe5.result;
        if (_0x201aac.derrors) {
          console.log(this.idx + " " + _0x4f9eb8.fn + " " + _0x201aac.errors.details + "\n");
        }
        if (_0x201aac.data) {
          let _0x36496a = Number(_0x201aac.data.chances);
          console.log(this.idx + " " + _0x4f9eb8.fn + " " + _0x201aac.data.chances + " 次\n");
  ...
  async sign() {
    ...
    try {
      ...
      _0x173212 = Object.assign({}, await this.taskApi(_0xafff0a, _0x5369d5));
      if (200 == _0x173212?.["statusCode"] && _0x173212.result) {
        let _0x3d6164 = _0x173212.result;
        if (_0x3d6164.derrors) {
          console.log(this.idx + " " + _0xafff0a.fn + " " + _0x3d6164.errors.details + "\n");
          this.fb = 1;
        }
        if (_0x3d6164.data) {
          console.log(this.idx + " " + _0xafff0a.fn + " 已连签 " + _0x3d6164.data.sign_title.title[1] + " 天\n");
        }
        await this.signx();
      }
    } catch (_0x45541f) {
  ...
  async signx() {
    ...
    try {
      ...
      _0x326a28 = Object.assign({}, await this.taskApi(_0x5e3786, _0x406408));
      if (200 == _0x326a28?.["statusCode"] && _0x326a28.result) {
        let _0x17000c = _0x326a28.result;
        if (_0x17000c.errors) {
          console.log(this.idx + " " + _0x5e3786.fn + "  " + _0x17000c.errors.title + " ");
        }
        if (!_0x17000c.errors) {
          console.log(this.idx + " " + _0x5e3786.fn + " 获得 " + _0x17000c.data.coin + " 金币");
        }
      }
    } catch (_0x4e85c6) {
  ...
  async extracting() {
    ...
    try {
      ...
      _0x136cbd = Object.assign({}, await this.taskApi(_0x10c690, _0x3e0ecb));
      if (200 == _0x136cbd?.["statusCode"] && _0x136cbd.result) {
        let _0x4b6958 = _0x136cbd.result;
        if (_0x4b6958.data.prize_title) {
          console.log(this.idx + " " + _0x10c690.fn + " 抽中 " + _0x4b6958.data.prize_title + " ");
        }
      }
    } catch (_0x3e0093) {
...
function _0x2d19bf() {
  ...
  _utf8_decode = function (_0x5666d4) {
    for (c1 = c2 = 0, _0x344502 = "", _0x364c2a = 0, _0x13a4fd = c1 = c2 = 0, undefined; _0x364c2a < _0x5666d4.length;) {
  ...
  return new class {
    ...
    getdata(_0x2f249c) {
      ...
      if (/^@/.test(_0x2f249c)) {
        ...
        let _0x67de47 = _0x542389 ? this.getval(_0x542389) : "";
        if (_0x67de47) {
          try {
    ...
    setdata(_0x5747cd, _0x93e567) {
      ...
      if (/^@/.test(_0x93e567)) {
        ...
        let _0x242e19 = this.getval(_0x6acdc9);
        try {
    ...
    setval(_0x4e68b5, _0x5b2f10) {
      return this.isSurge() || this.isLoon() ? $persistentStore.write(_0x4e68b5, _0x5b2f10) : this.isQuanX() ? $prefs.setValueForKey(_0x4e68b5, _0x5b2f10) : this.isNode() ? (this.data = this.loaddata(), this.data[_0x5b2f10] = _0x4e68b5, this.writedata(), true) : this.data && this.data[_0x5b2f10] || null;
    }
    send(_0x406deb, _0x2a40d4, _0x40abd3 = () => {}) {
      ...
      if ("get" == _0x406deb && _0x2a40d4.headers ? (delete _0x2a40d4.headers["Content-Type"], delete _0x2a40d4.headers["Content-Length"]) : _0x2a40d4.body && _0x2a40d4.headers && !_0x2a40d4.headers["Content-Type"] && (_0x2a40d4.headers["Content-Type"] = "application/x-www-form-urlencoded"), this.isSurge() || this.isLoon()) {
        ...
        "get" == _0x406deb && delete _0x3a9375.data;
        $axios(_0x3a9375).then(_0x38bed3 => {
          let {
            status: _0x4f7970,
            request: _0x56d19e,
            headers: _0x40ba51,
    ...
    padStr(_0x4f5523, _0xe6e027, _0x5d9cb6 = "0") {
      ...
      let _0x2a68ee = _0xe6e027 > _0x352de2.length ? _0xe6e027 - _0x352de2.length : 0;
      let _0x23345a = "";
    ...
    json2str(_0x5a046d, _0x52a9d5, _0x47f221 = false) {
      let _0x1f3674 = [];
    ...
    str2json(_0x8bb9ac, _0x40a321 = false) {
      let _0x59befd = {};
      for (let _0x3fd77e of _0x8bb9ac.split("&")) {
        ...
        let _0x4d1cd0 = _0x3fd77e.substr(_0xf0295a + 1);
    ...
    wait(_0x2d79ec) {
      ...
      let _0x299ca5 = (_0x54b8ce - this.startTime) / 1000;
